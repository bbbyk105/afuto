...
export const facility = {
  intro:
    "オフィスの改修から大規模なプラント工事まで、設計・施工・保守点検・配管・土木・塗装と幅広く対応しています。まずは現場を確認し、ご予算と目的に合わせた進め方をご提案します。工事後の維持管理まで引き受けるので、建物と設備を長く良い状態に保てます。",
  tabs: [
    {
      key: "construction",
      label: "建設事業",
      body: "オフィスや店舗、工場、商業施設など、使い方に合わせた建物を設計から手がけます。現地調査やご提案から施工、引き渡しまで同じ担当が窓口になるので、途中で話が途切れる心配がありません。",
    },
    {
      key: "interior",
      label: "内装工事",
      body: "レイアウト変更や間仕切りの増設、退去時の原状回復まで対応します。働きやすさと会社の雰囲気づくりの両方を考えて、内装を仕上げます。",
    },
    {
      key: "exterior",
      label: "外装工事",
      body: "外壁や屋根、看板の工事で、建物の見た目と耐久性を整えます。その場しのぎではなく、十年先まで持たせることを前提にご提案します。",
    },
    {
      key: "renovation",
      label: "大規模修繕工事",
      body: "建物の傷み具合を調べるところから、計画的な修繕・改修までお任せいただけます。傷みが大きくなる前に手を打つことで、修繕にかかる費用を抑えられます。",
    },
    {
      key: "vending",
      label: "自動販売機設置サポート",
      body: "どこに置くかのご相談から、設置後の補充やメンテナンスまで引き受けます。社員の方に喜ばれて収益にもつながる置き方を、一緒に考えます。",
    },
  ] as FacilityTab[],
};
